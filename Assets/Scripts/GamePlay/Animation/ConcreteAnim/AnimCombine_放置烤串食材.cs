...
public partial class AnimCombine_放置烤串食材{
    public static IAnimTask Anim_放置单个食材(FoodInstanceView foodInstanceView, int index, Transform waitingPlace, BBQView bbqView){
        ...
        IAnimTask animTask_SetParent = new ActionAnimTask(() => {
            ...
            foodInstanceView.transform.SetParent(slotTransform, true);
        });
        Transform transform = foodInstanceView.transform;
